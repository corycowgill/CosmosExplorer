...
const BUILDERS = { scout: buildScout, fighter: buildFighter, cruiser: buildCruiser };
...
class Alien {
  ...
  update(dt, playerPos, difficulty) {
    ...
    // Spin scouts/cruisers a bit for character.
...
export class AlienManager {
  constructor(scene, projectiles, audio) {
    ...
    this.audio = audio;
    this.aliens = [];
    this.pools = { scout: [], fighter: [], cruiser: [] };
    this.wave = 0;
    this.toSpawn = 0;
    this.spawnTimer = 0;
    this.difficulty = 1;
